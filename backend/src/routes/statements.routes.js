...
router.get("/undecided", async (req, res) => res.json({ lines: await store.undecidedLines({ includePaid: req.query.includePaid === "true", onlyWithoutNote: req.query.onlyWithoutNote === "true" }) }));
