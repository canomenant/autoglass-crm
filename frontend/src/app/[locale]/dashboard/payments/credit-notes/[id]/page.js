...
export default function CreditNoteDetailPage() {
  ...
  function load() {
    getCreditNote(id).then(setNote).catch((e) => setError(e.message));
  }
  ...
  return (
    <div>
      <Link href="/dashboard/payments/credit-notes" className="text-sm text-gray-500">← {t("creditNotesTitle")}</Link>
