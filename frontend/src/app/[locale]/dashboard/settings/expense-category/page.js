...
const rowColors = ["text-orange-600", "text-blue-600", "text-purple-600"];
...
export default function ExpenseCategoryPage() {
  const t = useTranslations("settingsCatalog.expenseCategory");
  ...
  function load() {
    getExpenseCategories().then(setItems).catch((e) => setError(e.message));
  }
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <SettingsIcon name="receipt" className="w-6 h-6 text-gray-800" />
          <div>
