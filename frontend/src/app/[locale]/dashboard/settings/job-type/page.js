...
import { getJobTypes, createJobType, updateJobType, deleteJobType } from "@/lib/api";
...
export default function JobTypePage() {
  const t = useTranslations("settingsCatalog.jobType");
  ...
  async function handleSave(e) {
    ...
    try {
      if (editing) {
        await updateJobType(editing.id, form);
      } else {
